...
const members = () => {
  ...
  return (
    <div className="h-full w-full  gap-2 p-2 bg-[#262626] rounded-b-lg border-x-[0.5px] border-b-[0.5px] border-zinc-600  overflow-scroll">
      {/* All students info  */}
      <div className="w-full mb-3 h-20  bg-[#333333] rounded-lg flex items-center px-2 gap-2 transition-all duration-200 focus-within:ring-2 focus-within:ring-[#5C766D]"></div>

      {/* Search Bar */}
      <div className="w-full mb-3 py-2.5 bg-[#333333] rounded-lg flex items-center px-2 gap-2 transition-all duration-200 focus-within:ring-2 focus-within:ring-[#5C766D]">
        <RiSearchLine className="text-gray-300 text-sm" />

        <input
          type="text"
          placeholder="Search members..."
          className="flex-1 bg-transparent outline-none text-xs text-white placeholder-gray-400"
        />
      </div>
      {/* Students */}
